...
import { generateExampleVisualization } from "./Utils.jsx"
...
class Falx extends Component {
  ...
  renderExampleVisualization() {
    let spec = generateExampleVisualization(this.state.tags);
    return spec == null ? 
          (<div className="grey-message">Click "+" to add elements to your demonstration.</div>)
        : (<VegaLite spec={spec} tooltip={new Handler().call} actions={false}/>);
  }
